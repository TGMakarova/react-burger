import CJS_COMPAT_NODE_URL_eqtxpn81zmv from 'node:url';
import CJS_COMPAT_NODE_PATH_eqtxpn81zmv from 'node:path';
import CJS_COMPAT_NODE_MODULE_eqtxpn81zmv from "node:module";

var __filename = CJS_COMPAT_NODE_URL_eqtxpn81zmv.fileURLToPath(import.meta.url);
var __dirname = CJS_COMPAT_NODE_PATH_eqtxpn81zmv.dirname(__filename);
var require = CJS_COMPAT_NODE_MODULE_eqtxpn81zmv.createRequire(import.meta.url);
...
import {
  any
} from "./_node-chunks/chunk-Y2RNNRRF.js";
import {
  DOCUMENTATION_LINK
} from "./_node-chunks/chunk-LL7OP5YS.js";
import {
  require_dist
} from "./_node-chunks/chunk-PLHJMU6Z.js";
import {
  dirname,
  normalize,
  relative,
  resolve
} from "./_node-chunks/chunk-5JSLY6AK.js";
import {
  require_compare,
  require_constants,
  require_debug,
  ...
  require_re,
  require_semver
} from "./_node-chunks/chunk-F3BGOMP7.js";
import {
  __commonJS,
  __toESM
} from "./_node-chunks/chunk-KTZBHZTQ.js";
...
async function getTemplatePath(name) {
  switch (name) {
    case "vitest.config.template":
      return import("./_node-chunks/vitest.config-67ZQGJP5.js");
    case "vitest.config.4.template":
      return import("./_node-chunks/vitest.config.4-VNDTMKXM.js");
    case "vitest.config.3.2.template":
      return import("./_node-chunks/vitest.config.3.2-EY7FMMZY.js");
    case "vitest.workspace.template":
      return import("./_node-chunks/vitest.workspace-UCL4KJ3B.js");
    default:
